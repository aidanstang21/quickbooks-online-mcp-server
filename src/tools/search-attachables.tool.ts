...
const toolDescription = "Search attachables in QuickBooks Online that match given criteria.";

// Define the expected input schema for searching attachables
...
const toolHandler = async (args: any) => {
  const response = await searchQuickbooksAttachables(args.params);
  ...
  return {
    content: [
      { type: "text" as const, text: `Attachables found:` },
